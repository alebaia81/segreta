  ...
  return (
    <footer className="store-footer">
      <div className="container footer-content">
        {/* Sinistra: logo + dettagli aziendali legali + social */}
        <div className="footer-left">
          ...
          <div className="footer-company-details">
            ...
            <span className="footer-company-address">Via Martiri della Libertà 67 — 29010 Monticelli d'Ongina (PC)</span>
            <span className="footer-company-contacts">
              Tel: <a href="tel:0523820276">0523 820276</a> &nbsp;•&nbsp; Email: <a href="mailto:info@segretastyle.it">info@segretastyle.it</a>
            </span>
          </div>
        ...
        {/* Destra: policy + copyright + dati fiscali */}
        <div className="footer-right">
          ...
          <div className="footer-info-row">
            <span>© 2026 Segreta Style di Greta Righi — <a href="https://presenzadigitale.com" target="_blank" rel="noopener noreferrer">Presenzadigitale.com</a></span>
